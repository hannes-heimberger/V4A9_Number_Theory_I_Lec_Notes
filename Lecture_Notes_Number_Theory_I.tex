...
\begin{pf}
  ...
  \end{align*}
  Fix $d \leq h \leq \ell$. Clearly, $j_2 = h-j_1$. Now $x^{d-i_0}y^{i_0} \nmid x^{j_1}y^{j_2}$ implies that $d-i-0 > j_1$ or $i_0 > j_2$. Hence, $0 \leq j_1$ or $h-i_0<j_1 \leq h$. Since $h \geq d \geq i_0$, the number of choices for $j_1$ is $d-i_0+i_0 = d$. Therefore, \[\#\mathcal{M} =  \sum_{d \leq h \leq \ell} d = d(\ell-d+1) = k = d\ell + \O(d^2). \qedhere\]
\end{pf}
\end{document}
